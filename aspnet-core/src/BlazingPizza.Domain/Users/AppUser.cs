...
namespace BlazingPizza.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update BlazingPizzaDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update BlazingPizzaEfCoreEntityExtensionMappings to extend the IdentityUser entity
